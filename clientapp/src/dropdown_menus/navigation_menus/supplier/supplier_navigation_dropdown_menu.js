...
const MENU_ITEMS = [
    { id: "home", title: "Home", desc: "Back to Supplier Dashboard", path: "/supplier/Dashboard" },
    { id: "add", title: "Add Product", desc: "Create a new product listing", path: "/supplier/addProduct" },
];
